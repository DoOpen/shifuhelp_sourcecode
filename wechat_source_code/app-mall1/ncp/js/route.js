var app=angular.module('app',['ng', 'ngRoute', 'ngAnimate','ngTouch','ngCookies','me-lazyload'])
    .config(function($routeProvider){
        $routeProvider
            ...
            .when("/goodsClass",{ // 商品列表
                templateUrl:"ncp/html/goodsClass.html",
                controller:"goodsClass"
            })
            .when("/goodsListIntegral",{ // 积分商品列表
                templateUrl:"ncp/html/goodsListIntegral.html",
                controller:"goodsListIntegral"
            })
            .otherwise({
                redirectTo: "/"
            })
