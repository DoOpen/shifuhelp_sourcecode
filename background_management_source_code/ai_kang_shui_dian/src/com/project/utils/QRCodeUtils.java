...
public class QRCodeUtils {
	...
	public static String decode(File file) throws Exception {
		...
		Result result;
		HashMap<DecodeHintType, String> hints = new LinkedHashMap<DecodeHintType,String>();
	...
	public static String createImage(String path,String content) throws Exception {
		...
		path=path==null?"/images/merchants/qr":path+"/"+TimeUtils.getCurrentTime("yyyyMMdd")+"/";
	...
	public static Boolean CreateQrcode(HttpServletRequest request, String path,
		...
		try {
			...
			int height = 300;
			String format = "png";
			HashMap<EncodeHintType, String> hints = new LinkedHashMap<EncodeHintType, String>();
			hints.put(EncodeHintType.CHARACTER_SET, "utf-8");
			BitMatrix bitMatrix = new MultiFormatWriter().encode(desc,
					BarcodeFormat.QR_CODE, width, height, hints);
			File outputFile = new File(request.getSession().getServletContext()
					.getRealPath("/")
					+ path + "/" + fileName);
			MatrixToImageWriter.writeToFile(bitMatrix, format, outputFile);
