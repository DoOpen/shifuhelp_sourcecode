...
public abstract class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws InvocationTargetException, IllegalAccessException, SQLException{
		...
		RoutingStatementHandler statementHandler = (RoutingStatementHandler) invocation.getTarget();
			...
			PageBean pagingBounds = (PageBean) readField(handler, FIELD_ROWBOUNDS);
	...
	private void getTotalAndSetInPagingBounds(String targetSql, BoundSql boundSql, PageBean bounds,
	...
	protected abstract String getSelectPagingSql(String targetSql, PageBean pageBean);
	...
	public Object plugin(Object target) {
		if (target instanceof RoutingStatementHandler) {
			try {
				...
				if (rowBounds != RowBounds.DEFAULT && rowBounds instanceof PageBean) {
	...
	private Object readField(Object target, String fieldName) throws IllegalArgumentException, IllegalAccessException {
		if (target == null) {
			throw new IllegalArgumentException("target object must not be null");
		}
		Class<?> cls = target.getClass();
